    ...
    <div className='form-group'>
      ...
      <form className='input-form ' onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.drinkName?.message ? (
          <p className='required'>*{errors.drinkName?.message}</p>
        ) : null}
        ...
        {errors.ingredients?.message ? (
          <p className='required'>*{errors.ingredients?.message}</p>
        ) : null}
        <h4 className='create-form-heading'>
          How do you concoct this tasty beverage?
        </h4>
        <textarea
          className='form-control'
          rows='3'
        ...
        {errors.instructions?.message ? (
          <p className='required'>*{errors.instructions?.message}</p>
        ) : null}
